...
echo "🚀 Desplegando PickingRX Argentina a Google Cloud Platform..."
...
if [ ! -d "dist/picking-rx-argentina" ]; then
    echo "❌ Error: El build falló. La carpeta dist/picking-rx-argentina no existe."
    exit 1
fi
