  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  private readonly SCAN_DELAY = 500; // ms to wait for scanner to finish typing
  private readonly AUTO_FOCUS_INTERVAL = 5000; // 5 seconds
  isMobile =
  ...
  /**
   * Borra el último caracter del input
   */
  backspace(): void {
